  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-zinc-500 mt-2">Visão geral da academia e métricas principais.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Estimativa baseada em planos</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
